...
scons use_mingw=yes platform=windows target=editor module_mono_enabled=yes lto=full mesa_libs=$HOME\AppData\Local\Godot\build_deps\mesa-x86_64-llvm accesskit=no winrt=no angle=no
